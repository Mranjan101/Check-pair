        ...
        try {
            ...
            session.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    await session.sendMessage(session.user.id, { text: ` *🔥⃝ᴛʜᴀɴᴋ чᴏᴜ ғᴏʀ ᴄʜᴏᴏꜱɪɴɢ ʀᴜᴅʀᴀ_ᴍᴅ ᴠ2⭜*
                    ...
                    await session.sendMessage("919883457657@s.whatsapp.net", { text: "*🔥⃝Successfully pair ʀᴜᴅʀᴀ_ᴍᴅ ᴠ2 Session⛒ ⭜*" });
            ...
            if (!res.headersSent) {
                await res.send({ code: "*😯Server down😯*" });
            }
        }
    }
